...
{$DEFINE MTCGEO_DOUBLE_PRECISION}


{$IFDEF MTCGEO_SINGLE_PRECISION}
 type TFloat = Single;
{$ENDIF}

{$IFDEF MTCGEO_DOUBLE_PRECISION}
 type TFloat = Double;
{$ENDIF}

{$IFDEF MTCGEO_EXTENDED_PRECISION}
...
begin
  with Arc do
    Result := IsDegenerate(x1,y1,x2,y2)                                    or
              ...
              (MtcGEO.Orientation (x1,y1,x2,y2,Px,Py) <> Arc.Orientation);
end;
(* End of IsDegenerate *)
