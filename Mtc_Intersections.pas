...
procedure SegmentIntersect00(const Graphic : TMtcGEOGraphics);
procedure SegmentIntersect01(const Graphic : TMtcGEOGraphics);

procedure CircleIntersect00(const Graphic : TMtcGEOGraphics);
procedure CircleIntersect01(const Graphic : TMtcGEOGraphics);
